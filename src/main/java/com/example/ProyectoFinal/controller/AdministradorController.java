...
import com.example.ProyectoFinal.service.IContactoService;
import com.example.ProyectoFinal.service.IDetalleOrdenService;
import com.example.ProyectoFinal.service.IOrdenService;
import com.example.ProyectoFinal.service.IProductoService;
import com.example.ProyectoFinal.service.IUsuarioService;
...
public class AdministradorController {
    ...
    public String getPieChart(Model model) {
        ...
        for (int i = 0; i < detalles.size(); i++) {
            if (detalles.get(i).getNombre().equals("Yogurt")) {
                contador1 = contador1 + (int) detalles.get(i).getCantidad();
            }
            if (detalles.get(i).getNombre().equals("Paneton")) {
                contador2 = contador2 + (int) detalles.get(i).getCantidad();
            }
            if (detalles.get(i).getNombre().equals("Leche condensada")) {
                contador3 = contador3 + (int) detalles.get(i).getCantidad();
            }
            if (detalles.get(i).getNombre().equals("Tampico Cifrus")) {
                contador4 = contador4 + (int) detalles.get(i).getCantidad();
            }
            if (detalles.get(i).getNombre().equals("Mermelada")) {
                contador5 = contador5 + (int) detalles.get(i).getCantidad();
            }
            if (detalles.get(i).getNombre().equals("Leche Pura Vida")) {
                contador6 = contador6 + (int) detalles.get(i).getCantidad();
            }
            if (detalles.get(i).getNombre().equals("Queso Fresco")) {
                contador7 = contador7 + (int) detalles.get(i).getCantidad();
            }
            if (detalles.get(i).getNombre().equals("Frugos")) {
                contador8 = contador8 + (int) detalles.get(i).getCantidad();
            }
            if (detalles.get(i).getNombre().equals("Manjar Blanco")) {
                contador9 = contador9 + (int) detalles.get(i).getCantidad();
            }
            if (detalles.get(i).getNombre().equals("Bonle Cremosa")) {
                contador10 = contador10 + (int) detalles.get(i).getCantidad();
            }
            if (detalles.get(i).getNombre().equals("Leche en Polvo")) {
                contador11 = contador11 + (int) detalles.get(i).getCantidad();
            }
            if (detalles.get(i).getNombre().equals("Chicha morada")) {
                contador12 = contador12 + (int) detalles.get(i).getCantidad();
            }
            graphData1.put("Yogurt", contador1);
            graphData1.put("Paneton", contador2);
            graphData1.put("Leche condensada", contador3);
            graphData1.put("Tampico Cifrus", contador4);
            graphData1.put("Mermelada", contador5);
            graphData1.put("Leche Pura Vida", contador6);
            graphData1.put("Queso Fresco", contador7);
            graphData1.put("Frugos", contador8);
            graphData1.put("Manjar Blanco", contador9);
            graphData1.put("Bonle Cremosa", contador10);
            graphData1.put("Leche en Polvo", contador11);
            graphData1.put("Chicha morada", contador12);
        }
